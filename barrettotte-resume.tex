...
\begin{document}
	...
	\resumeheader{SKILLS}
		...
		\textbf{Frontend:}
			...
			\vspace*{5pt}
        \textbf{Data:}
			Postgres, DB2, MSSQL, Apache Kafka, ElasticSearch, Prometheus, Grafana\\
			\vspace*{5pt}
		\textbf{Tools/Other:}
	...
	\resumeheader{WORK HISTORY}
        ...
        \employer
			...
			\begin{resumelist}
				...
				\item Supported and learned IBM i legacy system using RPGLE, DB2 SQL, Control Language, and DDS.
